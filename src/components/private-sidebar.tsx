...
const upcoming = ["Agenda", "Clientes", "Caja"];
...
export function PrivateSidebar() {
  return <aside className="flex w-full shrink-0 flex-col border-b bg-white p-4 md:min-h-screen md:w-60 md:border-b-0 md:border-r">
    ...
    <nav className="flex flex-wrap gap-1 md:flex-col">
      ...
      <Link href="/barbers" className="rounded-md px-3 py-2 text-sm font-medium hover:bg-slate-100">Barberos</Link>
      <Link href="/services" className="rounded-md px-3 py-2 text-sm font-medium hover:bg-slate-100">Servicios</Link>
