...
export function AppointmentCard({ appointment, gridStartMinute, onClick }: { appointment: AppointmentData; gridStartMinute: number; onClick: () => void }) {
