...
import { AGENDA_PIXELS_PER_MINUTE, AGENDA_START_HOUR, AGENDA_TOP_GUTTER } from "@/lib/agenda";
...
export function AppointmentCard({ appointment, onClick }: { appointment: AppointmentData; onClick: () => void }) {
